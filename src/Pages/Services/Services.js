            ...
            <Col xs={12} md={12} className="text-center">
              <div className="section-header">
                <h2 className="text-center">
                  <span style={{ color: "#ffc412" }}>F</span>inancial Advices
                  Success
                </h2>
              ...
              <div className="section-info">
                <p>
                  ...
                  Finvision professionals understand how complex your life and
                  financial situation can be, and we're here to help. Our team
                  of certified financial planners can help you get the right
                  information so you can make the best decisions.
                </p>
          ...
          <Row className="m-5">
            ...
            <Col xs={12} md={4}>
              <Card className="mb-3 h-100">
                ...
                />
                <Card.Body>
                  <Card.Title>In Office Individual Tax Return</Card.Title>
                  <Card.Text>
                    <ul>
            ...
            <Col xs={12} md={4}>
              <Card className="mb-3 h-100">
                ...
                />
                <Card.Body>
                  <Card.Title>Company/Business Tax Return</Card.Title>
                  <Card.Text>
                    <ul>
